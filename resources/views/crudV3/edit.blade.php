...
<div>
    <form action="{{ URL::to('crud-v3/'.$data->id) }}" class="row g-3" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        <div class="col-12">
        ...
        <div class="col-md-6">
            <label for="image" class="form-label">Upload <code>New</code> Image</label>
        ...
        <div class="col-12">
            ...
            <a href="{{ URL::to('crud-v3') }}" class="btn btn-outline-info mt-3">All User List</a>
        </div>
    </form>
</div>
