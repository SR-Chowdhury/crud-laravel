...
<head>
    ...
    <link href="{{ asset('public//assets/v3.0/toastr_styles.css')}}" rel="stylesheet" />
...
<body>
    <div class="container py-3">
        ...
        <h2 class="text-center text-info">CRUD Laravel v3.0</h2>
    </div>
    ...
    <!-- toastr JS-->
    <script src="{{ asset('public/assets/v3.0/toastr_scripts.js') }}"></script>
