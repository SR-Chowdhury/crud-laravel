...
<div>
    <form action="{{ URL::to('crud-v2/store') }}" class="row g-3" method="POST" enctype="multipart/form-data">
    @csrf
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <a href="{{ route('home-v2')}}" class="btn btn-outline-info mt-3">All Student List</a>
        </div>
    </form>
</div>
