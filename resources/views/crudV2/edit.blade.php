...
<div>
    <form action="{{ URL::to('crud-v2/update/'.$data->id) }}" class="row g-3" method="POST" enctype="multipart/form-data">
    @csrf
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <a href="{{ route('home-v2')}}" class="btn btn-outline-info mt-3">All User List</a>
        </div>
    </form>
</div>
